...
export default function Rxpert() {
    ...
    return (
        <main className="overflow-x-hidden">
            ...
            <div className="diving-in px-32 py-20 grid grid-cols-1 bg-[#DDE5EC] md:grid-cols-2 justify-items-center">
                <div className="place-content-center mt-14 md:mt-0 mr-0 mb-10 md:mb-0 md:mr-10 lg:mr-0">
            ...
            <div className="diving-in px-32  py-20 grid bg-[#DDE5EC] grid-cols-1 md:grid-cols-2 justify-items-center">
                <div className="place-content-center mb-10 md:mb-0 mr-0 md:mr-10 lg:mr-0">
            ...
            <div className="inspiration px-32 py-20 grid grid-cols-1 bg-[#DDE5EC] justify-items-center">
                <h2 className="pb-1 text-[#8DA7BE] text-sm">Design</h2>
