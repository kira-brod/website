        ...
        <main className="overflow-x-hidden bg-[#0B1338] ">
            ...
            <div className={" grid content-between overflow-x-hidden max-w-7xl xl:mx-auto "}>
                <div className="grid grid-cols-1 justify-items-center mt-32">
                    <p className="text-5xl font-bold text-white mb-2  z-10">SFD Platform</p>
                    <p className="text-white mb-5 z-10 text-sm">Protothon (5/4 - 5/5/2025)</p>
                    <p className="text-white text-xl mx-80 text-center z-10">A web app designed during a protothon to aid the Seattle Fire Department with resource allocation.</p>
                    <Image className="-mt-24 " src="/img/SFD hero.png" alt="dashboard" width={1200} height={1200} />
