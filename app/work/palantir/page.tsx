    ...
    <PasswordProtected>
      <main className="overflow-x-hidden bg-[#0B1338] ">
        ...
        <div className={" grid content-between overflow-x-hidden  "}>
          <div className="grid grid-cols-1 justify-items-center mt-32 max-w-7xl xl:mx-auto">
          ...
          <div className="mt-28  bg-[#524DD9] py-16">
            <div className="grid justify-items-center place-items-center grid-cols-2 max-w-7xl xl:mx-auto">
              <div>
          ...
          <div className=" mt-28 max-w-7xl xl:mx-auto " >
            <p className="text-white text-xl mx-96 text-center z-10">Nebula Overflight Feature</p>
            <p className="text-white text-3xl font-bold mx-64 text-center z-10 mt-5">Nebula has an overflight feature that calculates when a satellite will be traveling over a certain location. There are currently no explicit use cases/users for this feature.</p>
          </div>

          <div className="grid grid-cols-1 justify-items-center mt-28 max-w-7xl xl:mx-auto ">
            <p className="text-white text-center text-2xl font-bold">Space Support Request Workflow</p>
          ...
          <div className="mt-28 grid grid-cols-1 justify-items-center ">
            ...
            <p className="text-white text-center mt-1">Consists of alerting for poor overflights</p>
            <Image className="mt-5 " src="/img/Alert.png" alt="dashboard" width={1000} height={500} />
          </div>
